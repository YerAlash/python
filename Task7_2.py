...
class Coat(Clothes):
    ...
    @property
    def cloth_outlay(self):
        return f"Расход ткани = {round(self.size / 6.5 + 0.5, 2)}"
...
class Suit(Clothes):
    ...
    @property
    def cloth_outlay(self):
        return f"Расход ткани = {2 * self.height + 0.3}"


myCoat = Coat('Кожаное пальто', 50)
print(myCoat.cloth_outlay, '\n')

mySuit = Suit('Спортивный костюм', 180)
print(mySuit.cloth_outlay)
